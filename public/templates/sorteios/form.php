...
<form method="POST" class="space-y-8" id="sorteio-form">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <!-- Regulamento -->
            <div class="lg:col-span-2">
                <label for="regulamento" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    Regulamento do Sorteio
                </label>
                <textarea id="regulamento" 
                          name="regulamento" 
                          rows="6"
                          maxlength="5000"
                          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                          placeholder="Cole aqui o regulamento completo do sorteio..."><?php echo htmlspecialchars($sorteio['regulamento'] ?? ''); ?></textarea>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Regras detalhadas, termos e condições (opcional)</p>
            </div>
